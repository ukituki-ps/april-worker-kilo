...
| [Frontend strategy](https://github.com/ukituki-ps/april-worker/blob/develop/docs/FRONTEND_STRATEGY.md) | Модель интеграции `Host-driven`/`Widget-driven`/`API/BFF-first` в AprilHub |
| [Контракты виджетов](https://github.com/ukituki-ps/april-worker/blob/develop/docs/WIDGET_CONTRACTS.md) | `HostContext`, props/events и правила интеграции host ↔ widget |

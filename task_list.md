...
- [ ] `028`: Исполнение внешней задачи 030 из `april-profile-1` (анализ docs + реализация + двойной отчёт)
...
- [ ] `028-aprilhub-execute-external-task-030-april-profile-1`: изучить задачу 030 и документацию в `april-profile-1`, реализовать требования и оформить отчёт в обоих репозиториях
...
| `028` | Исполнение внешней задачи 030 из `april-profile-1` (анализ docs + реализация + двойной отчёт) | ⏳ В работе | [`tasks/028-aprilhub-execute-external-task-030-april-profile-1/TASK.md`](./tasks/028-aprilhub-execute-external-task-030-april-profile-1/TASK.md) |

...
| `049` | Эпик: `@april/ui` / `@april/tokens` из приватного npm registry (DisignApril publish + Hub + Profile) | ⏳ Не начато | [`tasks/049-april-ds-registry-consumption-epic/TASK.md`](./tasks/049-april-ds-registry-consumption-epic/TASK.md), [`PLAN.md`](./tasks/049-april-ds-registry-consumption-epic/PLAN.md), [`README.md`](./tasks/049-april-ds-registry-consumption-epic/README.md) |

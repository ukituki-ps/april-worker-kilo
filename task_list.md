...
- [ ] `050-aprilhub-profiles-widget-submodule-bump`: обновление внешнего `profiles-widget` через submodule `vendor/april-profile`, quality gate `hub-shell`, при необходимости перезапуск `hub-shell` на dev / правка deploy
...
| `050` | Обновление внешнего `profiles-widget`: bump `vendor/april-profile`, проверки `hub-shell`, выкладка dev и при необходимости перезапуск `hub-shell` | ⚠️ Частично — [`REPORT.md`](./tasks/050-aprilhub-profiles-widget-submodule-bump/REPORT.md) | [`tasks/050-aprilhub-profiles-widget-submodule-bump/TASK.md`](./tasks/050-aprilhub-profiles-widget-submodule-bump/TASK.md), [`REPORT.md`](./tasks/050-aprilhub-profiles-widget-submodule-bump/REPORT.md) |

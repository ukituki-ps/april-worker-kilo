...
- [x] `050-aprilhub-profiles-widget-submodule-bump`: обновление внешнего `profiles-widget` через submodule `vendor/april-profile`, quality gate `hub-shell`, перезапуск `hub-shell` на dev — см. PR [#102](https://github.com/ukituki-ps/april-worker-kilo
...
| `031` | **Дубликат 025** — shell/IA/HostContext закрыт через PR [#46](https://github.com/ukituki-ps/april-worker-kilo
...
| `050` | Обновление внешнего `profiles-widget`: bump `vendor/april-profile`, CI hub-shell, deploy recreate — PR [#102](https://github.com/ukituki-ps/april-worker-kilo

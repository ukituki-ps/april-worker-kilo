...
2. Реализовать дизайн-системный guest landing (hero, value blocks, scenarios, primary CTA).
3. Усилить entrypoint UX: обработать запуск login flow и ошибки недоступности auth endpoint.
...
| Frontend | `hub-shell` guest landing, CTA login flow, тесты и стили |
...
- Ручная проверка / smoke:
  - Guest landing отображает hero, value cards и primary CTA.

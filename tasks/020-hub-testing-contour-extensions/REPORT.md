...
## 8) Что осталось
- [ ] Локально восстановить права/чистое состояние `hub-shell/node_modules` и прогнать полный `npm run e2e`.
- [ ] Провести follow-up по сетевому DNS в `run-k6-aprilhub-extended.sh` на CI/локали, подтвердить стабильный pass.

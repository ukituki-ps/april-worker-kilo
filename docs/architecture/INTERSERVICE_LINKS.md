...
| Из \ В | AprilWorker | AprilWorkFlow | AprilNFlow | AprilOrgFlow | AprilProfil | AprilEDC | AprilReport |
|---|---|---|---|---|---|---|---|
...
| **AprilProfil** | — | — | — | — | — | <span style="color:#2e7d32;"><strong>Sync:</strong></span> Запуск интеграционной задачи по бизнес-логике | — |

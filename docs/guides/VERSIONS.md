...
| `oasdiff` (OpenAPI compatibility) | `github.com/tufin/oasdiff@v1.10.29` | `.github/workflows/ci.yml`, `.github/workflows/ci-cache-warmup.yml` | Оба workflow должны иметь одинаковый pinned tag/module path |

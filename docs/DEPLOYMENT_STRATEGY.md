...
Ниже для **AprilHub** (репозиторий `ukituki-ps/april-worker-kilo
...
Чеклист для каталога **`DEPLOY_ROOT`** (клон `ukituki-ps/april-worker-kilo
